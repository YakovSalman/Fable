                                    ...
                                    <div class="orders-cards-wrap orders-cards-wrap-feature">
                                        ...
                                        <div class="orders-cards-feature orders-cards-feature-quantity">
                                            ...
                                            <div class="orders-cards-counter">
                                                <button class="orders-minus">-</button> <span>${card.quantity}</span> <button class="orders-plus">+</button>
                                            </div>
                                        </div>
                                    </div>
...
quantityProducts.forEach(quantityProduct => {
    const minus = quantityProduct.querySelector('.orders-minus')
    const plus = quantityProduct.querySelector('.orders-plus')
